...
UIConfigLocal.BlizzardTexturesColor = "Оттенок цвета текстур UI"
...
UIConfigLocal.MinimapEnable = "Включить миникарту"
...
UIConfigLocal.MinimapSize = "Размер миникарты"
...
UIConfigLocal.MiscKillingBlow = "Отображать Победный удар"
