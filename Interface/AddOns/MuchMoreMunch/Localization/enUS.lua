local L = LibStub("AceLocale-3.0"):NewLocale("MMMunch", "enUS", true)
...
L["Profile"] = true
L["Blizzard macro update aborted: An unrecognised macro called %s already exists. Please rename your macro."] = function(s)
