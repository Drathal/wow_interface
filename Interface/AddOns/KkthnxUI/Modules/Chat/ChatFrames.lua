...
hooksecurefunc("FCF_RestorePositionAndDimensions", SetupChatPosAndFont)

-- Chat Mover
local ChatMover = CreateFrame("Frame", "ChatMover", UIParent)
ChatMover:SetPoint(unpack(C.Position.Chat))
Movers:RegisterFrame(ChatFrame1)
