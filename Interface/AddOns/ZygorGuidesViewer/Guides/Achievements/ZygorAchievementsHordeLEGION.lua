...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievement Guides\\Raid\\Legion\\Wailing Halls",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievement Guides\\Raid\\Legion\\The Gates of Hell",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievement Guides\\Raid\\Legion\\Chamber of the Avatar",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievement Guides\\Raid\\Legion\\Deceiver's Fall",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievement Guides\\Raid\\Legion\\Fel Turky!",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievement Guides\\Raid\\Legion\\Grin and Bear it!",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievement Guides\\Raid\\Legion\\Grand Fin-ale",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievement Guides\\Raid\\Legion\\Five Course Seafood Buffet",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievement Guides\\Raid\\Legion\\Wax on, Wax off",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievement Guides\\Raid\\Legion\\Mythic: Goroth",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievement Guides\\Raid\\Legion\\Mythic: Sisters of the Moon",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievement Guides\\Raid\\Legion\\Mythic: Demonic Inquisition",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievement Guides\\Raid\\Legion\\Mythic: Desolate Host",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievement Guides\\Raid\\Legion\\Mythic: Harjatan",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievement Guides\\Raid\\Legion\\Mythic: Mistress Sassz'ine",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievement Guides\\Raid\\Legion\\Mythic: Maiden of Vigilance",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievement Guides\\Raid\\Legion\\Mythic: Fallen Avatar",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievement Guides\\Raid\\Legion\\Mythic: Kil'Jaeden",{
...
You can buy the pattern for this from Alexandra Bolera found here |goto Stormwind/0 53.2,81.6 |only Alliance
