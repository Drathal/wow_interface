...
CONFIG.TEXTURE_PATH = "Interface\\AddOns\\TargetNameplateIndicator\\Textures\\Shield"
...
CONFIG.OFFSET_X = 45 			   -- The x/y offset of the texture relative to the anchor point.
CONFIG.OFFSET_Y = -26
