local addon, ns = ...
local cfg = ns.cfg
local activate = cfg.activation.charlinks
...
UnitPopupButtons["WH"] = {text = "XunaMate", dist = 0, checkable = nil}
...
UnitPopupMenus["CL"] = {"A", "WH", "MHP", "WL", "WP"}
...
local LFG_LIST_SEARCH_ENTRY_MENU = {
  ...
  },
  {
    ...
    menuList = {
      ...
      {
        text = "XunaMate",
        func = function(_, name) ShowUrl(name,"xunamate") end,
        notCheckable = true,
        arg1 = nil,
        disabled = nil,
        notCheckable = true,
