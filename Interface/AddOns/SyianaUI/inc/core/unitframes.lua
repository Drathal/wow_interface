--UnitFrames 7.1-u1 - 30/10/2016
local addon, ns = ...
local cfg = ns.cfg
local activate = cfg.activation.customunitframes
...
function whoa_CheckClassification (self, forceNormalTexture)
	...
	if ( forceNormalTexture ) then
		self.borderTexture:SetTexture("Interface\\Addons\\SyianaUI\\inc\\textures\\unitframes\\UI-TargetingFrame");
	elseif ( classification == "minus" ) then
		self.borderTexture:SetTexture("Interface\\Addons\\SyianaUI\\inc\\textures\\unitframes\\UI-TargetingFrame");
		forceNormalTexture = true;
	elseif ( classification == "worldboss" or classification == "elite" ) then
		self.borderTexture:SetTexture("Interface\\Addons\\SyianaUI\\inc\\textures\\unitframes\\UI-TargetingFrame-Elite");
	elseif ( classification == "rareelite" ) then
		self.borderTexture:SetTexture("Interface\\Addons\\SyianaUI\\inc\\textures\\unitframes\\UI-TargetingFrame-Rare-Elite");
	elseif ( classification == "rare" ) then
		self.borderTexture:SetTexture("Interface\\Addons\\SyianaUI\\inc\\textures\\unitframes\\UI-TargetingFrame-Rare");
	else
		self.borderTexture:SetTexture("Interface\\Addons\\SyianaUI\\inc\\textures\\unitframes\\UI-TargetingFrame");
		forceNormalTexture = true;
	end
...
function whoa:playerFrame()
	if not UnitHasVehicleUI("player") then
		PlayerFrameTexture:SetTexture("Interface\\Addons\\SyianaUI\\inc\\textures\\unitframes\\UI-TargetingFrame")
		PlayerName:Hide()
